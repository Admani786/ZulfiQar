# Decompiled By Sahu Zada
# Github : https://github.com/MajidYarSahu381
...
__author__ = 'Sahu Zada'
__copyright = 'All rights reserved . Copyright  Sahu Zada'
...
╚═╝░░░░░╚═╝╚═╝░░╚═╝░╚═════╝░╚═════╝░╚═╝
 ...
 \033[32;1mCreator \033[37;1m: \033[33;1mZULFIQAR MAGSI
 \033[32;1mWhat'sapp\033[37;1m: \033[33;1m03340002925
"""
def reg():
    os.system('clear')
    print logo
    ...
    r = requests.get('https://raw.githubusercontent.com/Shani-Majid-Sahu-Zada/Filecrack/main/server.txt').text
    if to in r:
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Mr-zulfiQar\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mThanks To My Mind Mr-zulfiQar\x1b[1;91m'
    print 47 * '-'
